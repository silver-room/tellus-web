...
本サービスにおいては、登録希望者が本規約に同意の上、アプリをインストール及び起動することでユーザーとして登録されます。
...
ユーザーは、自己の責任において、本サービスにプラットフォーム（Google PlayやApp Store）ごとのゲームサービスに予め登録されているユーザー（以下、「プラットフォームのユーザー」といいます。）を通じてログインすることができます。
ユーザーはログインをすることで、デイリーチャレンジやリーダーボードの機能にアクセスできるようになります。
ユーザーは、いかなる場合にも、プラットフォームのユーザーを第三者に譲渡または貸与し、もしくは第三者と共用することはできません。
当団体は、プラットフォームのユーザーを通してログインされた場合には、そのプラットフォームのユーザーを登録しているユーザー自身による利用とみなします。
プラットフォームのユーザーが第三者に使用されたことによって生じた損害は、当団体に故意又は重大な過失がある場合を除き、当団体は一切の責任を負わないものとします。

## 第4条（売買契約）

本サービスにおいて、ログインしたユーザーは、アプリを通じてアプリ内機能を解禁するためのアイテム（以下、「課金アイテム」といいます。）を購入できます。
本サービスにおいては、ユーザーが当団体に対して購入の申し込みをし、プラットフォーム上で決済が完了した時点を持って、本利用規約とプライバシーポリシーに同意した上で売買契約が成立したものとします。
課金アイテムよって解禁される機能については、アプリ内のサブスクライブ画面に提示されます。
課金アイテムには2種類あり、一回限りの支払いとなる買い切り型と、定期的に支払いを行うサブスクリプション型があります。
サブスクリプション型は1ヶ月単位での自動更新となり、ユーザーは、ユーザーの裁量においていつでも、サブスクライブの停止により売買契約を中止することができます。
本サービスに関する決済方法やサブスクライブのキャンセル方法は、各プラットフォームに従います。
本サービスに大きな瑕疵が認められない限り、ユーザーへの払い戻しは行いません。

当団体は、ユーザーが以下のいずれかの事由に該当する場合には、当該ユーザーに事前に通知することなく、前項の売買契約を解除することができるものとします。

- ユーザーが本規約に違反した場合
- 当団体とユーザーの信頼関係が損なわれたと認める場合

## 第5条（知的財産権）

本サービスによって提供される画像、その他のコンテンツ（以下「コンテンツ」といいます）の著作権又はその他の知的所有権は、当団体に帰属し、ユーザーは、これらを無断で複製、転載、改変、その他の二次利用をすることはできません。
ただし、アプリ画面のスクリーンショットの転載に関しては、この限りではありません。
...
ユーザーは、当団体にメールで通知することにより、本サービスから退会できるものとします。
退会に際して、ユーザーは本サービスからユーザーの個人情報の削除を求めることができます。

## 第10条（保証の否認および免責事項）

当団体は、本サービスに事実上または法律上の瑕疵（安全性、信頼性、正確性、完全性、有効性、特定の目的への適合性、セキュリティなどに関する欠陥、エラーやバグ、権利侵害などを含みます。）がないことを保証するものではありません。
当団体は、本サービスによってユーザーに生じたあらゆる損害について、一切の責任を負いません。
ただし、本サービスに関する当団体とユーザーとの間の契約（本規約を含みます。）が消費者契約法に定める消費者契約となる場合、この免責規定は適用されませんが、この場合であっても、当団体は、当団体の過失（重過失を除きます。）による債務不履行または不法行為によりユーザーに生じた損害のうち特別な事情から生じた損害（当団体またはユーザーが損害発生につき予見し、または予見し得た場合を含みます。）について一切の責任を負いません。
...
ユーザーと当団体との間の通知または連絡は、ユーザーからメールを受けた場合のみ、メールによって行うものとします。
当団体は、連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い、これらは、発信時にユーザーへ到達したものとみなします。
