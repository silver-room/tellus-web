...
本サービスにおいて、ログインしたユーザーは、アプリを通じてアプリ内機能を解禁するための定期購入（以下、「サブスクライブ」といいます。）をすることができます。
サブスクライブによって解禁される機能については、アプリ内のサブスクライブ画面に提示されます。
本サービスにおいては、ユーザーが当団体に対して購入の申し込みをし、プラットフォーム上で決済が完了した時点を持って売買契約が成立したものとします。
売買契約は1ヶ月単位での自動更新となり、ユーザーは、ユーザーの裁量においていつでも、サブスクライブの停止により売買契約を中止することができます。
